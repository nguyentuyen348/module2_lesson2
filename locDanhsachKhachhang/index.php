...
<form action="" method="GET">
    Chọn ngày sinh từ: <input type="date" id="from" name="from" placeholder="yyyy/mm/dd"
                              value="">
    đến: <input type="date" id="to" name="to" placeholder="yyyy/mm/dd"
                value="">
    <input type="submit" id="submit" name="submit" value="Lọc">
</form>
<?php
$customerList = [
"1" => [
